...
public class BeanKit {
    ...
    public static <T> T fillBean(T bean, ValueProvider valueProvider) {
        ...
        try {
            ...
            throw new BeamException("填充Bean出现异常",e);
        }
        return bean;
    }
    ...
    public static <T> Map<String, Object> beanToMap(T bean, boolean isToUnderlineCase) {
        ...
        try {
            ...
            throw new BeamException("beanToMap转换出错",e);
        }
        return map;
    }
    ...
    public static void copyProperties(Object source, Object target, CopyOptions copyOptions) {
        ...
        try {
            ...
            throw new BeamException("copyProperties出现异常",e);
        }
                ...
                if (sourcePd != null) {
                    ...
                    if (readMethod != null && ClassKit.isAssignable(writeMethod.getParameterTypes()[0], readMethod.getReturnType())) {
                        try {
                            ...
                            throw new BeamException(ex, "Copy property [{}] to [{}] error: {}", sourcePd.getName(), targetPd.getName(), ex.getMessage());
                        }
                    }
                }
            }
